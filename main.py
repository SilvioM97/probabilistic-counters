...
if __name__ == "__main__":
  ...
  print("Dimensione dizionario: ", len(dizionario))
  top_30_keys = sorted(dizionario, key = dizionario.get, reverse = True)[:30]
  print(top_30_keys)
  print("Heavy hitters:")
  heavy_hitters = space_saving_counter.heavy_hitters(k)
  print(heavy_hitters)

  intersection = set(top_30_keys) & set(heavy_hitters)
  print("Intersezione: ", len(list(intersection)))
    
  #for el in space_saving_counter.heavy_hitters(k):
  # print(el)
